        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="banner-text">
              <h1>Brainstormr</h1>
              <p>
                AI-powered email helper that analyzes and creates professional
                emails based on quick one-line summaries. Get through all of
                your emails 10x faster, giving you more spare time!
              </p>
