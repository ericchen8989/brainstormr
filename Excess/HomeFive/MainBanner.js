    ...
    return (
      <section className="slider-area">
        ...
        >
          <SwiperSlide>
            <div
              className="brainstormr-slider-item"
              style={{ backgroundImage: `url(/images/home-five/slider1.jpg)` }}
            >
              <div className="d-table">
                <div className="d-table-cell">
                  <div className="container">
                    <div className="brainstormr-slider-text overflow-hidden one">
          ...
          <SwiperSlide>
            ...
            >
              <div className="d-table">
                <div className="d-table-cell">
                  <div className="container">
                    <div className="brainstormr-slider-text overflow-hidden two">
                      <span>IT & AI Services</span>
          ...
          <SwiperSlide>
            ...
            >
              <div className="d-table">
                <div className="d-table-cell">
                  <div className="container">
                    <div className="brainstormr-slider-text overflow-hidden three">
                      <span>IT & AI Services</span>
